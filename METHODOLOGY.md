...
| **Source** | FRED `CUSR0000SAS4` (BLS CPI, seasonally adjusted) — corrected 2026-07-23 from `CUSR0000SETG` ("Public Transportation", a narrower airfare/transit-heavy basket that had been mislabeled as this broader category since the phase was built; the coverage description below was already written for the correct broader concept, only the series ID was wrong) |
